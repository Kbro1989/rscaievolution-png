...
const BALL_OF_WOOL_ID = Items.BALL_OF_WOOL;
const BOWSTRING_ID = Items.BOWSTRING;
const FLAX_ID = Items.FLAX;
const SPINNING_WHEEL_ID = Objects.SPINNING_WHEEL;
const WOOL_ID = Items.WOOL;

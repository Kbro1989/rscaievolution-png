...
This project builds upon the work of many talented individuals and organizations:

- **Jagex Ltd** - Original creators of RuneScape Classic
- **[Skillbert/RSMV](https://github.com/skillbert/rsmv)** - Cache decoding and model viewing tools
- **[Keep RSC Alive Foundation / 2003Scape](https://github.com/2003scape)** - RSC preservation, textures, and sprites
- **Open Source Community** - React, Three.js, and all supporting libraries

For complete attribution details, see [CREDITS.md](./CREDITS.md).

> **Legal Notice**: This is a non-commercial, educational fan project. RuneScape is a trademark of Jagex Ltd. Not affiliated with or endorsed by Jagex.
